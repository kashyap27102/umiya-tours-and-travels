...
export default function Footer() {
  ...
  const waUrl = `https://wa.me/${CONTACT.whatsappNumber}?text=Hi%2C%20I%27d%20like%20to%20inquire%20about%20your%20travel%20services.`;
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-brand-mist-200/80">
              Your Journey, Our Passion. Serving Gandhinagar, Gujarat with
              reliable travel services since 2 years.
            </p>
            {/* WhatsApp */}
            <a
              href={waUrl}
