  ...
  return (
    <section className="travel-shell">
      ...
      <div className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        ...
        {/* Tab switcher */}
        <div className="flex gap-2 rounded-full border border-brand-blue-900/10 bg-brand-blue-50 p-1 text-sm font-medium">
      ...
      <div className="mt-8 text-center">
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-semibold text-brand-blue-700 hover:text-brand-blue-900 hover:underline"
        >
